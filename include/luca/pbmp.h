...
struct luca_pbmp_state { const char *nick; const char *network; const char *channel; volatile int connected; volatile int channel_state; struct luca_command_queue *commands; };
