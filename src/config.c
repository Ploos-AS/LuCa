...
if(!strcmp(p,"botai_timeout_seconds"))c->botai_timeout_seconds=atoi(eq);else if(!strcmp(p,"reconnect_seconds"))c->reconnect_seconds=atoi(eq);else if(!strcmp(p,"tls"))c->tls=yes(eq);else if(!strcmp(p,"sasl"))c->sasl=yes(eq);
#undef K
